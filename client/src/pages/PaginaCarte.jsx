...
const unSaveCarte = async () => {
    ...
    try {
      ...
      console.error("Eroare la ștergerea cărții salvate:", error);
    }
  };
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-8 mt-6">
        {/* Card principal */}
        <div className="flex flex-col md:flex-row gap-8 ">
            ...
            <div className="space-y-4 flex-1">
                ...
                <div className="flex gap-4 items-center pt-4">
                    ...
                    <button
                       onClick={saved ? unSaveCarte : handleSave}
